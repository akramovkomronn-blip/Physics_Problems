...
Key terms to remember:$\cos(15^\circ)$: "Cosine of fifteen degrees"$v = \sqrt{2gh}$: "Velocity equals the square root of two $g$ $h$"Equilibrium position: The very bottom of the swing.
